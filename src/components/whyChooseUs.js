        ...
        <div className="whyChooseUs">
            ...
            <section>
                ...
                <ol>
                    ...
                    <li>
                        <strong>Send Your Order Details.</strong> Provide us with a list of your required tire sizes and quantities using our convenient form, designed to capture every detail and make ordering simple.
                    </li>
                    <li>
                        <strong>Secure Your Order.</strong> Confirm your order with a deposit of at least 30% of the agreed total C&F price, securing your place in our inventory.
                    </li>
                    <li>
                        <strong>Preparation Process.</strong> Relax while we handle the preparation. Here’s what we do to ensure quality and efficiency:
                        <ul>
                            <li>Contact our suppliers to compare prices and secure the best deals.</li> <li>Keep you updated once half of your order is stored, at which point you’ll be asked to complete the balance payment.</li>
                            <li>Share pictures of the tires with you, so you’re assured of the quality at every step.</li>
                        </ul>
                    </li>
                    <li>
                        <strong>Shipping.</strong> When your order is ready, we’ll:
                        <ul>
                            <li>Book the earliest available container vessel and share all booking details.</li>
                            <li>Provide the estimated time of departure (ETD) and estimated time of arrival (ETA) once confirmed by the shipping company.</li>
                            <li>Stay connected with you to assist with any further needs until your order arrives.</li>
                        </ul>
                    </li>
                </ol>
            </section>
            <p>Get in touch with us today to start your order! Our order form is here to simplify the process, so you can send us your tire requirements quickly and accurately.</p>
        </div>
    );
};
