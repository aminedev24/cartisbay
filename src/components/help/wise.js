...
const WisePaymentInstructions = () => {
  return (
    <div className='terms-container'>
      ...
      <ol>
        <li>Create an Account: If you’re new to Wise, visit <a href='https://wise.com/' className='cta-link'>Wise’s website </a> and sign up for an account.</li>
      ...
      <p>Wanna check the help section on Wise’s website? <a className='cta-link' href="https://wise.com/help">Click here</a>.</p>
