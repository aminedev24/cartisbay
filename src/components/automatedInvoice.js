  ...
  return (
    <div className="automated-invoice terms-container">
      ...
      <ul>
        ...
        <li><strong>Multi-Currency Support:</strong> Generate invoices in your preferred currency for international transactions.</li>
        <li><strong>Customizable Descriptions:</strong> Edit invoice descriptions to clearly outline the purpose of payments, ensuring smooth approval from banks.</li>
        <li><strong>Save Time:</strong> Skip the delays—generate and access invoices instantly.</li>
      ...
      <p>
        ...
        precise documentation for international transactions, it’s the perfect solution to streamline
