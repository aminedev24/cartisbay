...
const ArtisbayInfo = () => {
  return (
    <div className='whyChoose'>
      ...
      <div>
        <h2>3. Customized Services for Every Need</h2>
        <p>
      ...
      <div>
        <h2>4. Transparent Process with Full Documentation</h2>        
        <p>
      ...
      <div>
        <h2>6. Reliable and Professional Service</h2>
        <p>
