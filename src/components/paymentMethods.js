...
const PaymentMethods = () => {
  return (
    <div className='howtopay'>
      ...
      <h2>Payment FAQ</h2>
      <h3>How can I make a payment via Telegraphic Transfer (T/T)?</h3>
      ...
      <h3>Does Artisbay Inc. accept payment through Letters of Credit (L/C)?</h3>
      <p>Currently, Artisbay Inc. does not accept payments via Letters of Credit (L/C).</p>
      
      <h3>Can I use a credit card for payment?</h3>
      ...
      <h3>Is PayPal an accepted payment method?</h3>
      ...
      <h3>What does the “Due Date” on my invoice mean?</h3>
      ...
      <h3>Can I request an extension on the payment due date?</h3>
      ...
      <h3>Can I split my payment into installments?</h3>
      ...
      <h3>Is it possible to consolidate payments for multiple orders?</h3>
