...
const AuctionLanding = () => {
  return (
    <div className='terms-container'>
      <h2>Source Cars from Japanese Auctions with Artisbay Inc.</h2>
      <p>
      ...
      <h2>Already Found the Car You Want? Let Us Handle the Rest</h2>
      <p>
      ...
      <h2>Why Japanese Car Auctions?</h2>
      <p>
      ...
      <h2>Start Your Auction Journey with Artisbay Inc.</h2>
      <p>
